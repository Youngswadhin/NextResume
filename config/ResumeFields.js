export default {
    contact: {
        ...
        name: 'Contact',
        fields: [
            { name: 'name', label: 'Full Name', placeholder: 'Tony Stark', required: true },
            { name: 'title', label: 'Your Job Title', placeholder: 'Software Developer' },
            { name: 'email', label: 'Email', type: 'email', placeholder: 'Tony.Stark@example.com' },
            { name: 'phone', label: 'Phone', type: 'tel', placeholder: '+1234567890' },
            { name: 'address', label: 'Address', placeholder: '123 Street, City, Country' },
            { name: 'linkedin', label: 'Linked', placeholder: 'linkedin.com/in/TonyStark' },
            { name: 'github', label: 'Github', placeholder: 'github.com/TonyStark' },
            { name: 'blogs', label: 'Blogs', placeholder: 'github.com/TonyStark' },
            { name: 'twitter', label: 'Twitter', placeholder: 'github.com/TonyStark' },
            { name: 'portfolio', label: 'Portfolio', placeholder: 'TonyStark.com' },
        ],
    },
    summary: {
        name: 'Summary',
